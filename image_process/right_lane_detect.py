...
class right_images:
    def __init__(self):
        self.right_sub = rospy.Subscriber("/zed2/zed_node/right/image_rect_color", Image, self.frame_processor)
        self.x_error_right_pub = rospy.Publisher('x_error_right', Float64, queue_size=3)
    ...
    def frame_processor(self, msg):
        ...
        if not (left_lane_pixel is None or right_lane_pixel is None):
            ...
            self.x_error_right_pub.publish(off_center_distance)
